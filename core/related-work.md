...
<script type="application/ld+json">
{
  ...
  "@id": "https://alignmentconstraint.org/core/related-work/#article",
  "headline": "Relation to Existing Alignment Work",
  "description": "How the Alignment Constraint Framework relates to inner alignment, Goodhart's Law, RLHF, scalable oversight, interpretability, and corrigibility.",
  "author": {"@type": "Person", "name": "John Silliphant"},
  "url": "https://alignmentconstraint.org/core/related-work/",
  "isPartOf": {"@type": "CreativeWorkSeries", "name": "The Alignment Constraint Framework", "url": "https://alignmentconstraint.org/"},
  "keywords": ["AI alignment", "inner alignment", "reward hacking", "Goodhart's Law", "RLHF", "scalable oversight", "interpretability", "corrigibility", "specification coherence"]
}
</script>
